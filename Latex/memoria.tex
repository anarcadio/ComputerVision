...
\end{equation}
Donde $I_x$ e $I_y$ son las derivadas parciales de la función intesidad en las direcciones $x$ e $y$ respectivamente\footnote{Estas derivadas se aproximan como hemos explicado en el ejemplo 5 de \ref{derivadas} }.
...
La función propuesta por Shi y Tomasi proporciona por tanto buenos resultados y, empíricamente se ha observado que en muchos caso mejores que los que proporciona la original de Harris.
...
\end{enumerate}
El hecho de que el brillo no varíe, es decir, que la intensidad de un píxel se mantiene, junto con que hemos supuesto que el movimiento entre dos fotogramas es relativamente pequeño nos lleva a la siguiente igualdad:
